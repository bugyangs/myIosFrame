...
// GCJSONKit
#define COCOAPODS_POD_AVAILABLE_GCJSONKit
#define COCOAPODS_VERSION_MAJOR_GCJSONKit 1
#define COCOAPODS_VERSION_MINOR_GCJSONKit 5
#define COCOAPODS_VERSION_PATCH_GCJSONKit 0
...
#define COCOAPODS_VERSION_PATCH_RNActivityView 5
